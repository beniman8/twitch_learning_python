...
class Ball(pygame.sprite.Sprite):
    ...
    def __init__(self, groups,paddle_sprite,update_score):
        super().__init__(groups)
        ...
        # shadow surf 
        self.shadow_surf = self.image.copy()
        pygame.draw.circle(self.shadow_surf,COLORS['ball'],(SIZE['ball'][0]/2,SIZE['ball'][1]/2),SIZE['ball'][0]/2)
            ...
            if sprite.rect.colliderect(self.rect):
                if direction == 'horizontal':
                    if self.rect.right > sprite.rect.left and self.old_rect.right <= sprite.old_rect.left:
                        ...
                        self.direction.x *= -1
                    if  self.rect.left <= sprite.rect.right and self.old_rect.bottom  <= sprite.old_rect.top:
